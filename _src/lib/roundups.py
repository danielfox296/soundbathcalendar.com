...
def render_index(posts, nav_prefix):
  ...
  <div class="container rup-narrow">
    ...
    <p class="cal-summary">Occasional, human-edited cuts of the calendar: which rooms are busy, what costs nothing, what only happens once. Built from the listings, kept honest.</p>
    <ul class="rup-list">
{listing}
    </ul>
  </div>
