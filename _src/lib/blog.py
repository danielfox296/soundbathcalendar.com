...
.post-meta { font-size: 0.85rem; color: rgba(var(--ink-rgb), 0.62); margin: 0 0 2.2rem; }
.post-body h2 {
...
.post-body p { color: rgba(var(--ink-rgb), 0.74); line-height: 1.68; margin: 0 0 0.9rem; }
.post-body ul { margin: 0 0 0.9rem; padding-left: 1.2rem; }
.post-body li { color: rgba(var(--ink-rgb), 0.74); line-height: 1.6; margin: 0 0 0.35rem; }
...
.post-item__dek { color: rgba(var(--ink-rgb), 0.74); line-height: 1.6; margin: 0.35rem 0 0; }
.post-item__meta { font-size: 0.82rem; color: rgba(var(--ink-rgb), 0.62); margin: 0.35rem 0 0; }
.post-item__kind {
  font-weight: 600;
